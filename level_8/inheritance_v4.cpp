...
class clsDeveloper : public clsEmployee {
    ...
    public:
    clsDeveloper(string Firstname, string LastName, string Email, string Phone, int ID,
        string Title, string Department, float Salary, string MainProgrammingLanguage):
        clsEmployee(Firstname, LastName, Email, Phone, ID, Title, Department , Salary) {
...
int main() {
    ...
    clsDeveloper SWE_Carlos("carlos", "costa", "carlos@mail.com", "7952583465",
        111, "junior SWE", "Development", 500, "C++");
    SWE_Carlos.PrintData();

    SWE_Carlos.SendSMS("HI, \nhope you are doing good,\n"
                       "i was wondering about the situation of "
                       "the last project, is it ready yet???? ");
